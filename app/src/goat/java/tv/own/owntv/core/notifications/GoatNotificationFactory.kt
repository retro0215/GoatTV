...
/**
 * Custom Pushwoosh notification factory for GoatTV to handle channel migration.
 * DERIVED FROM: Goal to move to IMPORTANCE_HIGH (4) via a new channel ID.
 */
class GoatNotificationFactory : PushwooshNotificationFactory() {

    companion object {
        const val CHANNEL_ID = "goattv_notifications_v2"
        const val CHANNEL_NAME = "GoatTV Notifications"
    }
