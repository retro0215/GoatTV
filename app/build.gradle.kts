...
android {
    ...
    defaultConfig {
        ...
        // LOCAL builds (i.e. debug), so we pin it to 99.99.99 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â that way a dev build is always "newer"
        ...
        // properties file, so CI and every published APK compile it out ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â R8 drops the dead branch.
        buildConfigField(
            "boolean",
            "DEV_TOOLS",
            (
        ...
        // working ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â a blank key makes the app fall back to the unprotected workers.dev base URL.
    ...
    // When neither source is configured ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â fork CI, or a fresh clone ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â nothing here applies and
    ...
    packaging {
        jniLibs {
            ...
            // source ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â none carries a .debug_info or .symtab section. AGP's strip step therefore has
...
// own source set ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â required here because it has to be recorded on an x86_64 emulator (baseline
...
//
// The same check CI runs, moved onto the developer's own machine. CI is still the enforcing gate ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â
...
// means the string moves to strings_*.xml or is declared technical ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â those are the only two exits.
abstract class VerifyI18nLiterals : DefaultTask() {
    ...
    fun verify() {
        ...
        if (python == null) {
            ...
            // instead ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â CI still enforces it, so the worst case is a late failure, not a missed one.
            logger.warn(
        ...
        if (result.exitValue != 0) {
            ...
            throw GradleException("Hardcoded text check failed ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â see the report above.")
        }
...
dependencies {
    ...
    // Compat splash screen (audit ST3) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â branded cold start instead of a blank window.
    ...
    // Media playback ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â libmpv (FFmpeg) engine
    implementation(libs.libmpv)
    // Media3 / ExoPlayer ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â used ONLY for the VOD + image-subtitle (PGS/VOBSUB/DVB) handoff, where it
    ...
    // DASH (.mpd) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â the container protected channels use (#115). DefaultMediaSourceFactory only
    // builds a DASH source when this is on the classpath; without it a .mpd fails as "unsupported".
    implementation(libs.androidx.media3.exoplayer.dash)
    implementation(libs.androidx.media3.ui)
    implementation(libs.androidx.media3.datasource.okhttp)

    // In-app YouTube trailer playback (plan ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§7.3) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â WebView-backed IFrame player; the only ToS-clean
